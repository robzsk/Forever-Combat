...
var World = function () {
	...
	this.addPlayerTwo = function (input, spawn, angle) {
		...
		handleFireBullet(playerTwo, function () {
			factory.spawnBullet(playerTwo, bulletTwo);// TODO: this is going to call for each playerone should only do it once
		});
		bulletTwo.push(factory.createBullet());// TODO: this is a mistake need to assign not push here
